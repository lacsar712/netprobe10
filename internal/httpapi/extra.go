...
import (
	...
	"example.com/netprobe/internal/backup"
	"example.com/netprobe/internal/model"
	"example.com/netprobe/internal/policy"
	"example.com/netprobe/internal/report"
	"example.com/netprobe/internal/validate"
	"example.com/netprobe/internal/workflow"
)
...
func (s *Server) handleBackup(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Disposition", "attachment; filename=netprobe.zip")
	_, _ = w.Write(b)
}
